...
<body>
    ...
    <main>
        ...
        <section>
            <h3 class="baloo_title gap" style="margin: 15px">Remplissez le formulaire suivant pour créer un nouvel article </h3>
        </section>
        <section>
            <form action="../processing/article.php" method="POST" enctype="multipart/form-data">
                <div class="article_edit">
                    ...
                    <div class="label_input">
                        <label for="subject">Quel est le sujet de votre article</label>
                        <input type="text" name="subject" id="subject">
                    </div>
                    <div class="label_input">
                        <label for="image">Choisissez un média illustratif pour votre article</label>
                        <input type="file" name="file" id="image">
                    </div>
                    <div class="label_text">
                        <label for="description">Saisissez le texte de votre article</label>
